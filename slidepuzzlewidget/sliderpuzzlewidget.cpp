...
void SliderPuzzleWidget::initForm()
{
	...
	ui.puzzlewidget->setPixmap(":/FrmSlidePuzzleWidget/Resources/back1.jpg");
}
...
void SliderPuzzleWidget::onSliderReleased()
{
	...
	ui.puzzlewidget->setPixmap(QString(":/FrmSlidePuzzleWidget/Resources/back%1.jpg").arg(testIndex));
}